...
/**
 * Fase 1 — Crítica ao modelo (combustível/transporte). Pedido do usuário
 * 2026-08-05: "montar uma aba com crítica ao modelo, sendo que cada
 * problema deve ter o reconhecimento formal, ou até mesmo ajuste na
 * origem" — a partir do achado real da placa TBH2C10 (hodômetro travado).
 * Achados recalculados ao vivo a cada carregamento; só o status de
 * tratamento é persistido (`CriticaModeloAchado`).
 */
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-slate-500">
        Achados recalculados ao vivo a partir de todo o histórico de abastecimento — não é uma lista fixa.
        Cada problema em aberto precisa de reconhecimento formal (fica registrado quem e por quê) ou ser
        encaminhado para ajuste na origem (Officium/telemetria), antes de sumir da lista de pendências.
      </p>
